...
system intended to act in the accordance of the alliance's 
goals, the alliance has several freedoms available to 
them. The alliance does not need to expend as much cognitive 
effort, in the manner of roundabout calculations and 
extraneous learning processes, on tasks that have been 
accounted for by working processes of the system. This 
is a form of automation, and is the premise behind the 
power of automation: passive control by the sentience 
in charge of administering that system, since the 
sentience does not have been the direct actors for 
those processes delegated to that system. 