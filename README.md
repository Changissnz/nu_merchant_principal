...
effort that could have went into efforts for other outlets. 
Various manners by which "questions", perceived as offenses, 
are posed are not educational or advisory to the prideful. 
Instead, the "questions" are challenges that somewhat 
demand the prideful to be self-effacing, and the opening 
of self-effacement is not just for mere mockery. Their 
image is supposed to be permanently tainted, their 
capabilities to be contained for the other's stated 
