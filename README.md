...
Each participant is assigned different starting numbers from 
others, by which to perform arithmetic on. Given what 
restrictions of operators and numerical ranges placed equally 
on them, each participant has a relatively fair opportunity 
of reaching any number reached by any other. A participant 
that cannot reach a number that another participant can reach 
is still left with their own numbers, so a rationale for 
fairness can still be made in these cases. 
